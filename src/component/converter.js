...
export default class converter extends React.Component {
   ...
   callAPI(base) {
    ...
    render() {
      ...
      return(
        <div className="form-container currency">
          <h2 className="concept">CURRENCY CONVERTER</h2>
         ...
         <h4 id='result-text' style={{margin:"1em 0",color:"green"}}>{baseAmount} {baseCurrency} is equal to {result} {convertToCurrency}</h4>
          <Link to="/Login">
         <button type="button" className="btn btn-danger btn-block ">SignOut</button>
         </Link>
       </div>
      );
    }
